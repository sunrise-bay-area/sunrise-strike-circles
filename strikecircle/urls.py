...
from strikecircle.views import DataInput, ProgramGuide, ProgressDashboard, UpdateStrikeCircle, PledgeTable

app_name = 'strikecircle'
urlpatterns = [
    path('', ProgressDashboard.as_view(), name='dashboard'),
    path('data-entry/', DataInput.as_view(), name='data_input_dash'),
    path('data-input/', PledgeTable.as_view(), name='pledge_dashboard'),
